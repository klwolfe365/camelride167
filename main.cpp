...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("UCSD CSE 167 - Project 4 - Light and Shade"); //Open window and set window title
    ...
    glutSpecialFunc(Window::processFuncKeys);    //Register the callback for the mouse
    //Register the callback for the mouse motion
    glutMouseFunc(Window::processMouse);
    glutMotionFunc(Window::processMouseMovement);

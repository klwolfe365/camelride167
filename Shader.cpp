...
float Shader::water_level = 10;
float Shader::band_width = 0;
Vector4 Shader::color;

Vector3 Shader::normal;
Vector3 Shader::lightDir = Globals::dl.direction.toVector3();
Vector3 Shader::camera_pos = Globals::camera.e;
bool Shader::outline_on = true;
